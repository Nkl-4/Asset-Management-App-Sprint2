...
export const fetchAllAssets = () => {
  ...
  return (dispatch) => {
    // Returns a promise
    return Axios.get(apiUrl + '/manager/assets/get/all')
      .then((resp) => {
...
export const fetchAssetById = (assetId) => {
  return (dispatch) => {
    return Axios.get(apiUrl + '/manager/assets/get/' + assetId)
      .then((resp) => {
...
export const updateAsset = (payload) => {
  ...
  return (dispatch) => {
    return Axios.put(apiUrl + '/manager/assets/modify/' + payload.assetId, data)
      .then((response) => {
